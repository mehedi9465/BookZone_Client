                ...
                <Col xl={6} lg={7} md={9} sm={10} xs={9}>
                    <h1 className='display-2 text-center'>Login</h1>
                    {
                        ...
                        <Form className='my-5' onSubmit={handleSubmit}>
                            ...
                            <p >Or Sign in with</p>
                            <Button  onClick={() => googleSignIn(location, navigate)} className='rounded-pill mb-5' variant='outline-dark'> <Image src='https://cdn-icons-png.flaticon.com/512/2991/2991148.png' width='25' />&nbsp; &nbsp; &nbsp; &nbsp; Google &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</Button>
                        </>
                    }
                        {
                            user?.email &&
